#ifndef CUBIST_CUBICAL_H
#define CUBIST_CUBICAL_H

#include <stdbool.h>
#include <stddef.h>
#include <stdint.h>

/* Cubist kernel: interval and face algebra.
...
/* Dimension identifiers 0..63 are supported in the native representation.
