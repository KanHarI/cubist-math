...
The current increment adds `group_cosets`: equivalence of coset membership,
normality as the exact condition for right-translation compatibility,
multiplication/inverse compatibility, and kernel cosets as homomorphism fibers.
It connects representatives to equality paths in the predicate quotient.
The next step is quotient descent and resolving the bundled quotient's universe.
...
Current increment: all 22 coset declarations check; six focused regressions
