...
| Module | Results |
| --- | --- |
| [sample_chains](../../archive/first-library/sample_chains.cubist) | Vertices, tags, finite edge sums, and concatenation with endpoint laws. |
| [sample_sum_laws](../../archive/first-library/sample_sum_laws.cubist) | Additivity under matched concatenation, pointwise congruence, addition and additive maps, and telescoping. |
| [contour_samples](../../archive/first-library/contour_samples.cubist) | Contour-sum definitions and oriented-increment identities, available without importing the later sum theorems. |
| [contour_sums](../../archive/first-library/contour_sums.cubist) | Ring-valued contour sums, linearity in the integrand, and the constant-integrand formula `c * (last - first)`. Potential differences telescope; this is an algebraic identity, not a fundamental theorem of calculus. |
| [contour_refinement](../../archive/first-library/contour_refinement.cubist) | Exact changes under replacement of tags and splitting an edge; accumulated tag-error identity. |
| [contour_examples](../../archive/first-library/contour_examples.cubist) | Backtracking cancels with equal tags, and its error is explicit with different tags. A nonzero coarse sum on a closed chain is calculated. |
| [sample_error_bounds](../../archive/first-library/sample_error_bounds.cubist) | Pointwise scalar error bounds at the sampled edges accumulate into a bound on the total sum. |
| [complex_contour_sums](../../archive/first-library/complex_contour_sums.cubist) | Complex specialization: composition, zero for a closed constant-integrand sum, and the nonzero backtracking example. |
...
[field_magnitude](../../archive/first-library/field_magnitude.cubist) proofs show that these
...
[sample_magnitude_bounds](../../archive/first-library/sample_magnitude_bounds.cubist) proves
...
edges, using [SampleMagnitudeBounds](../../archive/first-library/sample_magnitude.cubist).

[contour_error_bounds](../../archive/first-library/contour_error_bounds.cubist) applies this
...
[field_magnitude_close](../../archive/first-library/field_magnitude_close.cubist) connects
...
[contour_tag_limits](../../archive/first-library/contour_tag_limits.cubist) proves closeness
...
[field_scale_limits](../../archive/first-library/field_scale_limits.cubist) supplies that
...
[complex_magnitude](../../archive/first-library/complex_magnitude.cubist) supplies the
...
[complex_contour_bounds](../../archive/first-library/complex_contour_bounds.cubist) proves
...
[complex_contour_tag_limits](../../archive/first-library/complex_contour_tag_limits.cubist)
...
[complex_convergence](../../archive/first-library/complex_convergence.cubist), and the finite
complex sum definition lives in
[complex_contour_samples](../../archive/first-library/complex_contour_samples.cubist).
