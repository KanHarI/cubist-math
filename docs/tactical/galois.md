...
[`embedded_composita`](../../archive/first-library/embedded_composita.cubist),
[`distinguished_extensions`](../../archive/first-library/distinguished_extensions.cubist), and
[`f4_embedded_composita`](../../archive/first-library/f4_embedded_composita.cubist).
...
the later algebra in the [roadmap](../roadmaps/galois-roadmap.md).
...
```sh
npm test -- archive/first-library/f4_galois_group.cubist
