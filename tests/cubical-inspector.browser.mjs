...
try {
  ...
  await reductionBench.locator("#delta-type").click();
  ...
  await reductionBench.locator("#beta-type").click();
  ...
  await reductionBench.locator("#beta-expression").click();
  assert.match(await reductionBench.locator("#reduction-status").textContent(), /No function/);
  await reductionBench.locator("#back").click();
