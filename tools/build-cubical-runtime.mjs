...
for (const name of ["core", "lattice", "equivalence", "translate", "number-transport", "pushouts", "path-over", "path-algebra", "public-equivalence", "dimension-slots", "dependent-transport", "adjointification"]) {
  const source = await readFile(new URL(`../experiments/cubical/${name}.mjs`, import.meta.url), "utf8");
