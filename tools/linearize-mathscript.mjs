...
if (args.includes("--help")) {
  ...
  if (!files.length) files.push(...(await readdir(new URL("../archive/first-library/", import.meta.url)))
    .filter(n => n.endsWith(".cubist")).sort().map(n => new URL("../archive/first-library/" + n, import.meta.url)));
