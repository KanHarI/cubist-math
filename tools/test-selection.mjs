...
export const defaultTests = ["tests/workbench.test.mjs", "tests/mathscript.test.mjs", "tests/test-runner.test.mjs", "tests/proof-watchdog.test.mjs", "tests/proof-library.test.mjs", "tests/group-identity.test.mjs", "tests/galois.test.mjs", "tests/universes.test.mjs", "tests/compiler-optimizations.test.mjs", "tests/compiler-equivalence.test.mjs", "tests/inspector-mathscript.test.mjs"];
