...
export const defaultTests = ["tests/tuples.test.mjs", "tests/documentation.test.mjs", "tests/formatter.test.mjs", "tests/workbench.test.mjs", "tests/mathscript.test.mjs", "tests/test-runner.test.mjs", "tests/proof-watchdog.test.mjs", "tests/proof-library.test.mjs", "tests/group-identity.test.mjs", "tests/galois.test.mjs", "tests/galois-fixed.test.mjs", "tests/generated-subfields.test.mjs", "tests/field-embeddings.test.mjs", "tests/distinguished-extensions.test.mjs", "tests/normal-subgroups.test.mjs", "tests/galois-correspondence.test.mjs", "tests/subgroup-images.test.mjs", "tests/group-cosets.test.mjs", "tests/universes.test.mjs", "tests/compiler-optimizations.test.mjs", "tests/compiler-equivalence.test.mjs", "tests/inspector-mathscript.test.mjs"];
