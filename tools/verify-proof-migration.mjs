...
// revision (default HEAD) is checked. See tools/proof-migration.mjs.
...
for (const report of reports) {
  ...
  console.log(`${report.failures.length ? "FAIL" : "ok  "} ${report.module}: ${report.identical} identical, ` +
...
console.log(`${modules.length} modules, ${failures} failures (level: ${level}).`);
